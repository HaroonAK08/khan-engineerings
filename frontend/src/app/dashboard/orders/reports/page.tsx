  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        ...
        <h1 className="text-nameplate text-xl">Sales & receivables</h1>
        <p className="mt-1 text-sm text-muted-foreground">
          Who owes money, unpaid invoices, and top customers.
        </p>
      </div>
      ...
      {loading || !report ? (
        ...
        <>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
            {[
              { label: "Orders", value: String(report.totals.orderCount), accent: "bg-chart-1" },
              {
                label: "Total sales",
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-nameplate text-sm">Who owes us money?</CardTitle>
              <CardDescription>Customers with open balances.</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-nameplate text-sm">Unpaid / partial invoices</CardTitle>
            </CardHeader>
            <CardContent>
              {report.outstanding.length === 0 ? (
                <p className="py-8 text-center text-sm text-muted-foreground">All invoices paid</p>
              ) : (
                <Table>
                  <TableHeader>
                    <TableRow>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Highest sales in the selected period.</CardDescription>
            </CardHeader>
            <CardContent>
              {report.topCustomers.length === 0 ? (
                <p className="py-8 text-center text-sm text-muted-foreground">No sales in period</p>
              ) : (
                <Table>
                  <TableHeader>
                    <TableRow>
